...
export interface OrderDetailsClientDialogData {
  orderId: number;
}

@Component({
  selector: 'app-client-orders-details-dialog',
  standalone: false,
  templateUrl: './order-details-dialog.component.html',
  styleUrl: './order-details-dialog.component.scss',
})
export class OrderDetailsClientDialogComponent {
...
constructor(
  @Inject(MAT_DIALOG_DATA) public data: OrderDetailsClientDialogData,
  private dialogRef: MatDialogRef<OrderDetailsClientDialogComponent>
) {}
