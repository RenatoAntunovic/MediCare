...
export class DialogHelperService {
  ...
  medicineCategory = {
    confirmDelete: (categoryName: string) => {
      return this.confirmDelete(
        categoryName,
        'MEDICINE_CATEGORIES.DIALOGS.DELETE_MESSAGE'
      );
    },
    ...
    showCreateSuccess: () => {
      return this.showSuccess(
        ...
        'MEDICINE_CATEGORIES.DIALOGS.SUCCESS_CREATE'
      );
    },
    ...
    showUpdateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'MEDICINE_CATEGORIES.DIALOGS.SUCCESS_UPDATE'
      );
    },
    ...
    showDeleteSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'MEDICINE_CATEGORIES.DIALOGS.SUCCESS_DELETE'
      );
    },
    ...
    showCreateError: () => {
      return this.showError(
        ...
        'MEDICINE_CATEGORIES.DIALOGS.ERROR_CREATE'
      );
    },
    ...
    showUpdateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'MEDICINE_CATEGORIES.DIALOGS.ERROR_UPDATE'
      );
    },
   ...
   */
  medicine = {
    confirmDelete: (medicineName: string) => {
      return this.confirmDelete(
        medicineName,
        'MEDICINE.DIALOGS.DELETE_MESSAGE'
      );
    },

    confirmCancel: () => {
      return this.confirm(
        'MEDICINE.DIALOGS.UNSAVED_CHANGES',
        'MEDICINE.DIALOGS.CONFIRM_CANCEL'
      );
    },
    ...
    showCreateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'MEDICINE.DIALOGS.SUCCESS_CREATE'
      );
    },
    ...
    showUpdateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'MEDICINE.DIALOGS.SUCCESS_UPDATE'
      );
    },
    ...
    showDeleteSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'MEDICINE.DIALOGS.SUCCESS_DELETE'
      );
    },
  ...
  treatmentCategory = {
    confirmDelete: (categoryName: string) => {
      return this.confirmDelete(
        categoryName,
        'TREATMENT_CATEGORIES.DIALOGS.DELETE_MESSAGE'
      );
    },
    ...
    showCreateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENT_CATEGORIES.DIALOGS.SUCCESS_CREATE'
      );
    },
    ...
    showUpdateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENT_CATEGORIES.DIALOGS.SUCCESS_UPDATE'
      );
    },
    ...
    showDeleteSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENT_CATEGORIES.DIALOGS.SUCCESS_DELETE'
      );
    },
    ...
    showCreateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'TREATMENT_CATEGORIES.DIALOGS.ERROR_CREATE'
      );
    },
    ...
    showUpdateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'TREATMENT_CATEGORIES.DIALOGS.ERROR_UPDATE'
      );
    },
    ...
    showDeleteError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'TREATMENT_CATEGORIES.DIALOGS.ERROR_DELETE'
      );
    }
  };

   treatment = {
    confirmDelete: (serviceName: string) => {
      return this.confirmDelete(
        serviceName,
        'TREATMENTS.DIALOGS.DELETE_MESSAGE'
      );
    },

    confirmCancel: () => {
      return this.confirm(
        'TREATMENTS.DIALOGS.UNSAVED_CHANGES',
        'TREATMENTS.DIALOGS.CONFIRM_CANCEL'
      );
    },
    ...
    showCreateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENTS.DIALOGS.SUCCESS_CREATE'
      );
    },
    ...
    showUpdateSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENTS.DIALOGS.SUCCESS_UPDATE'
      );
    },
    ...
    showDeleteSuccess: () => {
      return this.showSuccess(
        'DIALOGS.TITLES.SUCCESS',
        'TREATMENTS.DIALOGS.SUCCESS_DELETE'
      );
    },
    ...
    showCreateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'TREATMENTS.DIALOGS.ERROR_CREATE'
      );
    },
    ...
    showUpdateError: () => {
      return this.showError(
        'DIALOGS.TITLES.ERROR',
        'TREATMENTS.DIALOGS.ERROR_UPDATE'
      );
    },
