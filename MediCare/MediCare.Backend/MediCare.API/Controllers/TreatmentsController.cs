...
{
    [HttpPost]
    public async Task<ActionResult<int>> CreateTreatmentsCategory([FromForm] CreateTreatmentsCommand command, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task Update(int id, [FromForm] UpdateTreatmentsCommand command, CancellationToken ct)
    {
