...
{
    [HttpPost]
    public async Task<ActionResult<int>> CreateMedicineCategory(CreateMedicineCommand command, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task Update(int id, UpdateMedicineCommand command, CancellationToken ct)
    {
