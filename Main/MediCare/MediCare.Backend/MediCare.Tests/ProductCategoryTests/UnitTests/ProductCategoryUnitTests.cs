...
//namespace MediCare.Tests.ProductCategoryTests.UnitTests;
...
//        var handler = new CreateMedicineCommandHandler(context);
//        var command = new CreateMedicineCategoryCommand { Name = "Test Category" };

//        // Act
//        var resultId = await handler.Handle(command, CancellationToken.None);

//        // Assert
//        var category = await context.MedicineCategories.FindAsync(resultId);
